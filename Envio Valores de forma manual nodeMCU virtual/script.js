...
var url = "https://industrial.api.ubidots.com/api/v1.6/devices/node-mcu-virtual";//localiza em que dispositivo serão criadas as variéveis
var valor_mpu_01 = document.getElementById("first-input").value; //valor do botão digitado na página
var valor_mpu_02 = document.getElementById("second-input").value;//valor do sensor de umidade digitado na página

var dado = '{"mpu_01_ubdts":' + valor_mpu_01 + ',' + '"mpu_02_ubdts":' + valor_mpu_02 + '}'; // [VARIAVEIS CRIADAS NO UBIDIDOTS PELO JS] ==> entre aspas duplas = chave, entre os '+' = valor(armazenado na variável) 
